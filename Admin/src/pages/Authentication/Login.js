...
import logoImg from "../../assets/images/logs.jpg"
                  ...
                  {/* <h3 className="text-center mt-5 mb-4">
                   ...
                   <h3 className="text-center mt-5 mb-4">
                    <Link to="/" className="d-block auth-logo">
                      ...
                      <img src={logoImg} alt="" height="40" className="auth-logs" />
                    </Link>
                  </h3>

                  <div className="p-3">
                    <h4 className="text-muted font-size-18 mb-1 text-center">Welcome Back !</h4>
                    <p className="text-muted text-center">Sign in to continue to Aditya Engineering College.</p>
                    <Form
