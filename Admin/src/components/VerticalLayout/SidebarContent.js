          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <i class="mdi mdi-shopping"></i>
                <span>{props.t("Shops and Stalls info")}</span>
              </Link>
              <ul className="sub-menu" >
                <li>
                  <Link to="/shopinfolist">{props.t("Shops Info")}</Link>
                </li>
                <li>
                  <Link to="/stallinfolist">{props.t("Stalls Info")} </Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <i class="mdi mdi-home-modern"></i>
                ...
                <span>{props.t("Rent Status")}</span>
              </Link>
              <ul className="sub-menu" >
                <li>
                  <Link to="/shoprentlist">{props.t("Shops Rent Info")}</Link>
                </li>
                <li>
                  <Link to="/stallrentlist">{props.t("Stalls Rent Info")} </Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <i class="mdi mdi-lightbulb"></i>
                <span>{props.t("Power Bill Status")}</span>
              </Link>
              <ul className="sub-menu" >
                <li>
                  <Link to="/shopbilllist">{props.t("Shops Power Bill Info")}</Link>
                </li>
                <li>
                  <Link to="/stallbilllist">{props.t("Stalls Power Bill Info")} </Link>
                </li>
              </ul>
            </li>
